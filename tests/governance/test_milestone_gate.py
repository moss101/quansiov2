...
PY = sys.executable
GATES_UNDER_TEST = ["GATE-M0", "GATE-M1", "GATE-M2", "GATE-M3", "GATE-M4"]
...
EXPECTED = {"GATE-M0": EXPECTED_M0, "GATE-M1": EXPECTED_M1, "GATE-M2": EXPECTED_M2, "GATE-M3": EXPECTED_M3, "GATE-M4": EXPECTED_M4}
# a direct predecessor whose evidence removal must fail the gate
PROBE_PREDECESSOR = {"GATE-M0": "gov-003", "GATE-M1": "dat-003", "GATE-M2": "run-003", "GATE-M3": "mod-003", "GATE-M4": "ctx-003"}
PROBE_NAME = {"GATE-M0": "GOV-003", "GATE-M1": "DAT-003", "GATE-M2": "RUN-003", "GATE-M3": "MOD-003", "GATE-M4": "CTX-003"}
